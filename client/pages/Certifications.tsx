  ...
  const certifications = [
    {
      ...
      issuedDate: "2026",
      description:
        "Government-issued advanced intelligence training covering cyber investigations, OSINT methodologies, digital profiling, and national-level cyber awareness.",
      icon: Shield,
    ...
    <div className="flex flex-col min-h-screen bg-transparent pt-20 relative overflow-hidden">
            ...
            {certifications.map((cert) => (
              ...
              >
                <div className="flex items-start justify-between mb-10 relative z-10">
                  <div
                    className={`w-20 h-20 rounded-2xl ${cert.color} flex items-center justify-center border border-white/10 shadow-lg group-hover:scale-110 transition-transform duration-500`}
                  >
                ...
                <div className="flex-grow space-y-8 relative z-10">
                  <p
                    className={`text-xs font-bold uppercase tracking-wider ${cert.color} bg-clip-text text-transparent font-display`}
                  >
                    {cert.category}
                  </p>

                  <h3 className="text-4xl font-bold tracking-tight text-foreground font-display leading-tight">
                    {cert.title}
                  </h3>
      ...
      <section className="py-48 relative overflow-hidden z-10">
        ...
        <div className="container px-4 mx-auto text-center max-w-5xl">
          ...
          >
            <h3 className="text-5xl md:text-8xl font-bold mb-10 tracking-tight leading-none text-foreground">
              Defensible
              <br />
              <span className="text-muted-foreground/40 italic font-light">Findings.</span>
            </h3>

            <p className="text-2xl text-muted-foreground mb-16 font-medium leading-relaxed max-w-2xl mx-auto">
              Every investigation I conduct is supported by a foundation of technical expertise and verified methodology.
            </p>
