      ...
      <section className="py-32 relative z-10">
        <div className="container px-4 mx-auto text-center max-w-6xl">
          ...
          >
            ...
            <h2 className="text-5xl md:text-8xl font-bold mb-10 tracking-tight leading-none text-foreground">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-10">
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-14 py-7 rounded-full bg-primary text-primary-foreground font-bold hover:shadow-[0_0_50px_-12px_var(--primary)] transition-all duration-300 flex items-center gap-4 text-2xl shadow-2xl group/btn"
                >
                ...
                <motion.a 
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-14 py-7 rounded-full border-2 border-border bg-card/50 backdrop-blur-md hover:bg-secondary/30 transition-all flex items-center gap-4 text-2xl font-bold text-foreground shadow-xl group/link"
                >
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24">
            ...
            >
              ...
              <p className="text-2xl font-bold text-foreground">Within 24 Operational Hours</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-2xl font-bold text-foreground">PGP Available Upon Request</p>
            </motion.div>
