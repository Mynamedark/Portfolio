      ...
      <div className="lg:col-span-8 flex flex-col justify-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            >
              <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-primary mb-3 flex items-center gap-2 font-display">
                <Terminal className="w-3 h-3" /> Context
              </h4>
              <p className="text-lg text-muted-foreground leading-relaxed font-medium font-sans">{project.context}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed font-medium font-sans">{project.tools}</p>
            </motion.div>
          </div>
          <div className="space-y-8">
            <motion.div
            ...
            >
              ...
              <p className="text-lg text-foreground font-bold leading-relaxed font-sans">{project.findings}</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <p className="text-lg text-muted-foreground italic leading-relaxed font-medium opacity-70 font-sans">"{project.value}"</p>
            </motion.div>
          </div>
        </div>
      </div>
        ...
        <div className="container px-4 mx-auto text-center max-w-4xl">
          ...
          >
            <div className="flex justify-center mb-8">
              <div className="w-20 h-20 rounded-3xl bg-primary/10 flex items-center justify-center border border-primary/20 shadow-lg shadow-primary/5">
                <Lock className="w-10 h-10 text-primary" />
              </div>
            </div>
            <h3 className="text-4xl md:text-8xl font-bold mb-10 tracking-tight leading-none text-foreground font-display">
              Need Targeted <br />
              <span className="text-primary italic">Research?</span>
            </h3>
            <p className="text-2xl text-muted-foreground mb-16 font-medium leading-relaxed max-w-2xl mx-auto font-sans">
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center px-12 py-6 rounded-full bg-primary text-primary-foreground font-bold hover:shadow-[0_0_50px_-12px_var(--primary)] transition-all duration-300 text-xl shadow-2xl group font-display"
            >
