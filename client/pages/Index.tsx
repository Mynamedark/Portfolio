  ...
  return (
      <div className="flex flex-col min-h-screen bg-transparent">
        ...
        <section className="relative overflow-hidden pt-24 pb-20 md:pt-48 md:pb-64">
          <div className="container px-6 mx-auto relative z-10">
              <div
                className="max-w-5xl"
              >
                <motion.div variants={itemVariants} initial="hidden" animate="visible" className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-8 backdrop-blur-md">
                ...
                <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-foreground mb-10 leading-[0.95] md:leading-[0.9]">
                  Open-Source <span className="text-muted-foreground/40 italic font-light">Intelligence</span> & Cyber Research
                </h1>
                
                <motion.p variants={itemVariants} initial="hidden" animate="visible" className="text-lg md:text-2xl text-muted-foreground leading-relaxed max-w-2xl mb-14 font-medium border-l-2 border-primary/30 pl-6 md:pl-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
              <div>
                ...
                <motion.div
                  ...
                  className="space-y-6 md:space-y-8 text-lg md:text-xl text-muted-foreground leading-relaxed font-medium"
                >
                  <p>
        ...
        <section className="py-20 md:py-32 border-t border-border bg-background/20 backdrop-blur-sm">
          <div className="container px-6 mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-8 md:gap-10">
              <div>
